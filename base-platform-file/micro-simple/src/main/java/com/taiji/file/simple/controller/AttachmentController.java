...
import com.taiji.file.common.utils.UploadUtils;
import com.taiji.file.simple.utils.DocReadUtils;
...
public class AttachmentController extends BaseController implements IAttachmentRestService {
     ...
     */
    @PostMapping("/upload")
    public ResponseEntity<AttachmentVo> uploadFile(@RequestPart("file") MultipartFile file, @RequestParam("uploadModule") String uploadModule, HttpServletRequest request) throws Exception {
        ...
        String location = UploadUtils.uploadFile(file, uploadModule, fileType, uploadFileSavePath);
    ...
    public void downloadFile(@PathVariable("attId") String attId, HttpServletResponse response, HttpServletRequest request) throws Exception {
        ...
        UploadUtils.downloadFile(fileName, location, response, request, uploadFileSavePath);
    }
    ...
    public void downloadFiles(@PathVariable("attIds") String[] attIds, HttpServletResponse response, HttpServletRequest request) throws Exception {
        ...
        UploadUtils.downloadFiles(attachmentList, response, request, uploadFileSavePath);
    }
    ...
    public void showImage(@PathVariable("attId") String attId, HttpServletResponse response, HttpServletRequest request) throws Exception {
        ...
        UploadUtils.showImage(fileName, location, response, request, uploadFileSavePath);
    }
    ...
    public ResponseEntity<List<String>> readDocsContent(@RequestBody List<String> uploadFilePaths) throws Exception{
        List<String> result = DocReadUtils.readDocListContent(uploadFilePaths,uploadFileSavePath);
