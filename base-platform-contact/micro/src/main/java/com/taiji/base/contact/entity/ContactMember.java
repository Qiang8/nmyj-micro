...
@SelectBeforeUpdate
@Entity
@Table(name = "DW_CONTACT_MEMBER")
public class ContactMember extends BaseEntity<String> implements DelFlag {
     ...
     * 拼音
     */
    @Length(max = 4000,message = "pinyin字段最大长度100")
    @Getter
    @Setter
